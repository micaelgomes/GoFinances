...
Essa será uma aplicação para exibir as transações financeiras de entrada e saída em um Banco de Dados Relacional(Postgres com typeorm), um upgrade em relação ao desafio anterior. Além disso, o serviço deve permitir o cadastro, a listagem dessas transações e importar novos dados a partir de um arquivo CSV.
